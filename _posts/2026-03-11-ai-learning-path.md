...
| 参数 | 说明 | 推荐值 | 注意事项 |
|------|------|--------|----------|
| **temperature** | 控制随机性，0=确定性高，1=创意多 | 0.7 | OpenAI 用 0-2，Claude 用 0-1 |
| **top_p** | 核采样，控制输出多样性 | 0.9 | 与 temperature 二选一使用 |
| **max_tokens** | 限制输出长度 | 按需 | 避免过长导致成本增加 |
| **top_k** | 控制候选词数量 | 40-100 | 数值越小越保守 |
...
**开始学习**： [阶段1 - Python 开发基础](/blog/learning/2026/03/11/python-stage1/)
